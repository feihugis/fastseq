...
# ./benchmark.sh transformers facebook/bart-large-cnn cnn_dm.1k/raw test 32 --task summarization    # each loop 5 minutes
./benchmark.sh transformers+fastseq facebook/bart-large-cnn cnn_dm.1k/raw test 32 --task summarization --num_beams 4   # each loop 8 minutes
